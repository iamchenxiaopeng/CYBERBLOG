...
public interface ArticleService {
    IPage<ArticleVO> listArticles(int page, int size, String keyword, Long currentUserId, String guestId);
    ArticleVO getArticle(Long id, Long currentUserId, String guestId);
